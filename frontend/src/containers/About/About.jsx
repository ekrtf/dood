            ...
            <div className="container about">
                <div className="row about__content">
                    <div className="col col-md-12">
                        <section className="about__content__section--title">
                            <h1>Could your experience with online city guides be smarter?</h1>
                            {`That's the question this dissertation tries to answer.`}
                        </section>
                    </div>
                    <div className="col col-md-6">
                        <section className="about__content__section">
                            <h4 className="about__content__heading">What is this disseration about?</h4>
                            <p>
                            ...
                            <br/>
                            <p className="about__content__section--important">
                    ...
                    <div className="col col-md-6">
                        <section className="about__content__section">
                            <h4 className="about__content__heading">Why this experiment?</h4>
                            <p>
                        ...
                        <section className="about__content__section--important">
                            <h4 className="about__content__heading">What you need to do</h4>
                            <table className="table-condensed">
                                <tbody>
                                    <tr>
                                        <td className="about__content__table__num">Scenario:</td>
                                        <td className="about__content__table__rule">{`You're looking for a new place to visit in your city`}</td>
                                    </tr>
                                    <tr>
                                        <td className="about__content__table__num">1.</td>
                                        <td className="about__content__table__rule">Click "Get Started" below</td>
                                    </tr>
                                    <tr>
                                        <td className="about__content__table__num">2.</td>
                                        <td className="about__content__table__rule">Choose a place to visit (restaurant, museum, bar, theatre, monument… anything you want)</td>
                                    </tr>
                                    <tr>
                                        <td className="about__content__table__num">3.</td>
                                        <td className="about__content__table__rule">Rate your experience</td>
                                    </tr>
                                </tbody>
                            </table>
                        </section>
